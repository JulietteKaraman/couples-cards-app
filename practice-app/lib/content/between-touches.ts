...
export const betweenTouches: PracticeCollection = {
  ...
  entries: [
    // ---------------------------------------------------------------- 1
    {
      ...
      imageAlt: "A woman resting in a bath, taking a slow moment for herself",
      imageSide: "left",
      body: [
    ...
    // ---------------------------------------------------------------- 2
    {
      ...
      kind: "essay",
      image: "/between-touches/daily-life.png",
      imageAlt: "A couple standing close in a warmly lit doorway",
      imageSide: "right",
      body: [
    ...
    // ---------------------------------------------------------------- 3
    {
      ...
      image: "/between-touches/touch-base-banner.png",
      imageAlt: "Touch Base emblem, a hand pressing thumb to forefinger",
    ...
    // ---------------------------------------------------------------- 4
    {
      ...
      imageAlt: "A couple close together in warm, low light",
    ...
    // ---------------------------------------------------------------- 5
    {
      ...
      image: "/between-touches/what-she-says-banner.jpeg",
      imageAlt: "A couple embracing under an archway",
      eyebrow: "What's said. What's felt. What almost lands.",
      kind: "essay",
      imageSide: "left",
      body: [
    ...
    // ---------------------------------------------------------------- 6
    {
      ...
      image: "/between-touches/the-structured-conversation.jpeg",
      imageAlt: "Two hands reaching toward each other, black and white",
    ...
    // ---------------------------------------------------------------- 7
    {
      ...
      image: "/between-touches/when-words-dont-match-banner.jpeg",
      imageAlt: "A woman resting on a chair, thoughtful",
    ...
    // ---------------------------------------------------------------- 8
    {
      ...
      imageAlt: "Hands holding a set of the Intimacy and Communication Cards",
    ...
    // ---------------------------------------------------------------- 9
    {
      ...
      image: "/between-touches/tea-adjustment-banner.png",
      imageAlt: "Juliette Karaman, seated, in a red polka dot dress",
