  ...
  entries: [
    ...
    // ----------------------------------------------------------- closing
    {
      ...
      body: [
        ...
        { kind: "quote", text: "The Intimacy and Communication Cards" },
        { kind: "p", text: "The next practical step. Start with the Trust and Repair set." },
        { kind: "p", text: "Built specifically for the couples who love each other and have lost the thread. For the conversations that need to happen but haven't found the right container yet." },
        { kind: "p", text: "One card at a time. No pressure. No agenda. On your phone, now. Just a structure so you do not have to wait for the right moment or find the right words from nothing." },
        { kind: "link", text: "Explore the Cards →", href: "https://cards.feelfullyyou.com" },
