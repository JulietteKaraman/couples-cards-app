  ...
  entries: [
    // ---------------------------------------------------------------- intro
    {
      ...
      body: [
        ...
        {
          kind: "p",
          text: "These 10 rituals are not about fixing what's broken. They are about remembering what's already there.",
        },
        {
          kind: "p",
    ...
    },
    {
      ...
      body: [
        ...
        {
          kind: "p",
          text: "These 10 rituals are a way back into that conversation.",
          emphasis: "accent",
        },
        {
          kind: "big",
    ...
    // -------------------------------------------------------------- closing
    {
      ...
      kind: "closing",
      image: "/rituals/cards-upsell.jpg",
      imageAlt: "The Intimacy and Communication Cards",
      imageSide: "left",
      body: [
    ...
    },
    {
      ...
      imageAlt: "31 Daily Touch Points",
      imageSide: "left",
      body: [
        {
          kind: "big",
        ...
        { kind: "image", src: "/rituals/your-next-yes.png", alt: "31 Daily Touch Points" },
        { kind: "quote", text: "Daily Touch Points, 31 days to feel each other again" },
        {
          kind: "p",
          text: "Thirty-one days is not a random number. After 31 days a thing stops being something you remember to do and becomes something your body simply does.",
        },
        { kind: "p", text: "Not more effort. A new normal.", emphasis: "accent" },
        { kind: "p", text: "One Touch Point a day. A few minutes each. You show up, you slow down, and you let yourself be felt." },
        {
          kind: "link",
          text: "→ Daily Touch Points",
          href: "https://feelfullyyou.com/31-daily-touch-points",
        },
