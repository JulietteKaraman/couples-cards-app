...
export default function DistanceEntry() {
  return (
    <CollectionGate collectionSlug={theUnspokenDistance.slug}>
      <DistanceEntryContent />
    </CollectionGate>
  );
}

function DistanceEntryContent() {
  ...
  useEffect(() => {
    ...
    getCompletedSlugs(user.id, "unspoken-distance").then((slugs) =>
  ...
  async function handleMarkComplete() {
    ...
    await markComplete(user.id, "unspoken-distance", entry.slug);
    setCompleted(true);
  }
