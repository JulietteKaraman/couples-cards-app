...
export const STRIPE_TOUCH_LANGUAGES_PRICE_ID = process.env.STRIPE_TOUCH_LANGUAGES_PRICE_ID ?? process.env.STRIPE_TOUCH_LANGUAGES_PRICE_ID;
export const STRIPE_TRUST_REPAIR_PRICE_ID = process.env.STRIPE_TRUST_REPAIR_PRICE_ID ?? process.env.STRIPE_TRUST_REPAIR_PRICE_ID;
export const STRIPE_CORE_COLLECTION_PRICE_ID = process.env.STRIPE_CORE_COLLECTION_PRICE_ID ?? process.env.STRIPE_CORE_COLLECTION_PRICE_ID;
export const STRIPE_FULL_CORE_SET_PRICE_ID = process.env.STRIPE_FULL_CORE_SET_PRICE_ID ?? process.env.STRIPE_FULL_CORE_SET_PRICE_ID;
export const STRIPE_EVERYTHING_PRICE_ID = process.env.STRIPE_EVERYTHING_PRICE_ID ?? process.env.STRIPE_EVERYTHING_PRICE_ID;
