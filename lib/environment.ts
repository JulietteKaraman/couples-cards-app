...
export const STRIPE_TEST_SECRET_KEY = process.env.STRIPE_TEST_SECRET_KEY ?? process.env.STRIPE_TEST_SECRET_KEY;
export const STRIPE_COUPLES_PRICE_ID = process.env.STRIPE_COUPLES_PRICE_ID ?? process.env.STRIPE_COUPLES_PRICE_ID;
export const STRIPE_TEST_COUPLES_PRICE_ID = process.env.STRIPE_TEST_COUPLES_PRICE_ID ?? process.env.STRIPE_TEST_COUPLES_PRICE_ID;
