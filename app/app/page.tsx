...
function AppHomeContent() {
  ...
  const hasNeither = !hasCouples && !hasFriends;
    ...
    <main className="min-h-screen bg-black text-white">
      <div className="max-w-md mx-auto px-4 py-8">
        ...
        <div className="space-y-6">
          ...
          {/* Bundle Promo - only show if they don't have both */}
          {!hasBoth && (
            <div className="border-t border-white/10 pt-6 mt-6">
              <div className="bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 border border-white/10">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    href={hasNeither ? "/app/couples/unlock" : hasCouples ? "/app/friends/unlock" : "/app/couples/unlock"}
