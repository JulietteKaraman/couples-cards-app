...
const instructions = [
  "/cards/instructions/instructions1.png",
  "/cards/instructions/instructions2.png",
];

export default function CouplesTasterPlayPage() {
  const router = useRouter();
  const cards = getTasterCards("couples");
  ...
  function drawCard() {
    if (isLastCard && showCard) {
      router.push("/free/couples/upgrade");
      return;
    }
